...
import foraLogoBlack from '../assets/fora-logo-black.png'
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-secondary/20 bg-background py-12">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 px-4 text-center sm:px-6 lg:px-8">
        <div>
          <p className="font-heading text-lg font-semibold text-text">{siteConfig.name}</p>
          <p className="font-body text-sm text-secondary">{siteConfig.role}</p>
        </div>
